...
class ClassifierMLP(nn.Module):
    ...
    def forward(self, input):
        # print("dis output shape:", input.shape)
        y = self.net(input)
        # print("dis output shape:", y.shape)
        if self.last != None:
            y = self.last_layer(y)
...
class CNNlayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 mp_kernel_size=2, mp_stride=2, dropout=0.5):
...
class FeatureExtractor(nn.Module):
    ...
    def __init__(self, in_channel, window_sizes=[4, 8, 16, 32, 32], block=CNNlayer, dropout=0.5):#4，8，16，32，32
    ...
    def forward(self, input):
        ...
        # print("FeatureExtractor output shape:", out.shape)
        out = self.fl(out)
...
class BaseModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.C = ClassifierMLP(1280, num_classes, dropout, last=None)
